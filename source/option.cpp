...
int option_page = 1,max_option_page = 4, comboVoice, black;
...
void save_option() {
	...
	json_object_set(json, "blacktext", json_integer(Option.blacktext));
...
void load_option() {
	...
	if (json != NULL){
		...
		Option.blacktext = json_integer_value(json_object_get(json, "blacktext"));

...
void dan_condition() {
	...
	if ((strcmp(exam1[0], "g") == 0 && strcmp(exam1[3], "l") == 0 && (Gauge.norma / Gauge.soul) >= redCdn[0]) || (strcmp(exam2[0], "g") == 0 && strcmp(exam2[3], "l") == 0 && (Gauge.norma / Gauge.soul) >= redCdn[1]) || (strcmp(exam3[0], "g") == 0 && strcmp(exam3[3], "l") == 0 && (Gauge.norma / Gauge.soul) >= redCdn[2])) isBadCondition++;
//条件に以上がある場合、曲が終わるまで判定しない
	if (get_notes_finish() == true) {
		...
		if ((strcmp(exam1[0], "g") == 0 && strcmp(exam1[3], "m") == 0 && (Gauge.norma / Gauge.soul) <= redCdn[0]) || (strcmp(exam2[0], "g") == 0 && strcmp(exam2[3], "m") == 0 && (Gauge.norma / Gauge.soul) <= redCdn[1]) || (strcmp(exam3[0], "g") == 0 && strcmp(exam3[3], "m") == 0 && (Gauge.norma / Gauge.soul) <= redCdn[2])) isBadCondition++;
	}
}

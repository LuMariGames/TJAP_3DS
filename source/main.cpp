...
inline static void load_sprites(){
	...
	if(exist_file("sdmc:/tjafiles/theme/donchan.png")){
		...
		sprites[SPRITE_DONCHAN_0].params.w = 256; sprites[SPRITE_DONCHAN_0].params.h = 128;
		...
		sprites[SPRITE_DONCHAN_1].params.w = 256; sprites[SPRITE_DONCHAN_1].params.h = 128;
		...
		sprites[SPRITE_DONCHAN_2].params.w = 256; sprites[SPRITE_DONCHAN_2].params.h = 128;
		...
		sprites[SPRITE_DONCHAN_3].params.w = 256; sprites[SPRITE_DONCHAN_3].params.h = 128;
	}
